...
exports.ShippingModule = ShippingModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: shipping_config_schema_js_1.ShippingConfig.name, schema: shipping_config_schema_js_1.ShippingConfigSchema }])],
