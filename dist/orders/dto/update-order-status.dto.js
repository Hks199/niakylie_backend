...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: order_schema_js_1.OrderStatus, example: order_schema_js_1.OrderStatus.PACKED, description: 'New order status' }),
    (0, class_validator_1.IsEnum)(order_schema_js_1.OrderStatus),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], UpdateOrderStatusDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Packed and ready for dispatch', description: 'Optional notes for the timeline' }),
